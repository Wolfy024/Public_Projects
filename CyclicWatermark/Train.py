import config
from Architecture.Model import CyclicGenerator1, CyclicGenerator2, Discriminator
import data
...
if __name__ == "__main__":
    ...
    gen1 = CyclicGenerator1().to(config.device)
    disc1 = Discriminator().to(config.device)
    gen2 = CyclicGenerator2().to(config.device)
